...
interface LegacyPasswordSettings {
  length: number;
...
interface LegacyPasswordTemplate {
  id: string;
  name: string;
  description: string;
  category: string;
  icon?: string;
  settings: Partial<LegacyPasswordSettings>;
}

interface PasswordSettingsLegacyProps {
  settings: any; // Accept any settings for compatibility
  onSettingsChange: (settings: any) => void;
  templates: any[]; // Accept any templates for compatibility  
  onApplyTemplate: (templateId: string) => void;
}

export const PasswordSettingsLegacy = ({
  settings,
  onSettingsChange,
  templates,
  onApplyTemplate
}: PasswordSettingsLegacyProps) => {
  const updateSetting = <K extends keyof LegacyPasswordSettings>(
    key: K,
    value: LegacyPasswordSettings[K]
  ) => {
